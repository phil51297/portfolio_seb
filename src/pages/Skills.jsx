export const Skills = () => {
    return (
        <section id="skills" className="min-h-screen flex justify-center py-20">
            <div className="w-11/12 max-w-7xl mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20">
                    <div className="rounded-[25px] relative overflow-hidden group hover:-translate-y-1 transition-all">
